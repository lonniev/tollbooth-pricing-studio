        ...
        if let toolPrices = proposal?.toolPrices, !toolPrices.isEmpty {
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    // Header
                    HStack(spacing: 0) {
                        Text("Tool").font(.caption.bold()).frame(minWidth: 120, alignment: .leading)
                        Text("Category").font(.caption.bold()).frame(width: 100, alignment: .leading)
                        Text("Price").font(.caption.bold()).frame(width: 80, alignment: .trailing)
                        Text("Type").font(.caption.bold()).frame(width: 60, alignment: .trailing)
                    }
                    .padding(.horizontal, 8)
                    .padding(.vertical, 6)
